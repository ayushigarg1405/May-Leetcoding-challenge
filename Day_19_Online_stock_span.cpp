...
Solution Approach:
Creating a stack of pair with stores price and span.
Keep pushing the pairs whenever no lesser element present.
Keep pushing and calculating span whenever lesses or equal price present
